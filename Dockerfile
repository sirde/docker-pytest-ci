...
RUN py -3 -m pip install -U bottleneck teamcity-messages pytest pytest-cov mock xmltodict requests pylint coloredlogs pyserial nfcpy ipaddress flaky pyopenssl python-dateutil pytz rauth
